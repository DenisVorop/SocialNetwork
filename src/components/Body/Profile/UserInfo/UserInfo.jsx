...
let UserInfo = (props) => {
    ...
    // <button onClick={toggleClass} className={isActive ? active : button}
    ...
    <div className="contact">
        ...
        <nav>
            <a href="#" className="gmail">
                ...
                <svg className="arrow" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"> <g class="nc-icon-wrapper" fill="#444444"> <path d="M17.17 32.92l9.17-9.17-9.17-9.17L20 11.75l12 12-12 12z"></path> </g> </svg>
            </a>
